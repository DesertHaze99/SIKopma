                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahdata" >Tambah Penerimaan Barang</button>
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">ID Purchase Order</label>
                            <div class="form-line">
