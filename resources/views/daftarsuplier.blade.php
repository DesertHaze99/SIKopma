                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahdata" >Tambah Supplier</button>
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        @foreach($daftarsuplier as $data)
                                        <tr>
                                            <td>{{$data->nama_suplier}}</td>
                                            <td>{{$data->alamat_suplier}}</td>
                                            <td>{{$data->nohp_suplier}}</td>
                                            <td>{{$data->email_suplier}}</td>
                                            <td>{{$data->npwp_suplier}}</td>
                                            <td>
